...
/**
 * Controlador REST responsável pelas operações de autenticação e gestão
 * de contas de usuário no microservice <b>ms_user</b>.
 *
...
public class AuthController {
    ...
    /**
     * Endpoint utilizado por outros microservices ou gateways para validar
     ...
     * outros microservices que registram usuários automaticamente (ex.: médicos
     * e pacientes).</p>
     *
     ...
     * microservices de médicos e pacientes para sincronização interna.
     *
    ...
    public ResponseEntity<Void> updatePassword(@RequestBody @Valid FirstPasswordChangeDTO data) {
        authenticationService.updatePassword(data.newPassword());
        return ResponseEntity.ok().build();
    }
